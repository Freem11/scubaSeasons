        ...
        answer: (
            <>
                ...
                <ol className={styles.deletionSteps}>
                    ...
                    <li>{'Navigate to profile section through bottom navigation.'}</li>
                    <li>{'Tap gear icon.'}</li>
                    <li>{' Scroll down to the bottom and tap delete account.'}</li>
                </ol>
            </>
        )
    }
        ...
        <Section>
          <div className={styles.faqContent}>
            {faqs.map((faq, index) => {
              ...
              return (
                  <div key={index} id={questionId} className={styles.faqItem}>
